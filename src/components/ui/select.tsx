...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-12 w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-4 py-2 text-base text-gray-900 placeholder:text-gray-400',
      'ring-offset-white transition-colors',
      'focus:outline-none focus:ring-2 focus:ring-proterra-lime-500 focus:ring-offset-2',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-proterra-lime-500 focus:text-proterra-navy-900',
